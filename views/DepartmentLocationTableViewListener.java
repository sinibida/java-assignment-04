...
public class DepartmentLocationTableViewListener implements TableViewListener {
  ...
  static final String INSERT_STATEMENT = "INSERT INTO DEPATMENT_Locations VALUES (?, ?)";
  ...
  public DepartmentLocationTableViewListener(SQLRunner runner) {
    this.runner = runner;
